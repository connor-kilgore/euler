...
(describe "Euler 1"
  (context "sums all multiples of 3 and 5 up to n"

    (it "by checking if a number is a multiple of 3"
    ...
    (it "by checking if a number is a multiple of 5"
    ...
    (it "getting a lazy sequence up to n and sums all the multiples of 3 or 5 together"
      (should= 0 (euler-1 0))
      (should= 3 (euler-1 4))
      (should= 8 (euler-1 6))
      (should= 0 (euler-1 -1))
